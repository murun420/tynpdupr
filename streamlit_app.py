...
SCHEDULE_8_DBL = [("A", "G", "D", "C"),("E", "H", "F", "B"),("C", "F", "D", "H"),("A", "E", "G", "B"),
                  ("G", "D", "E", "F"),("C", "A", "H", "B"),("G", "F", "D", "A"),("E", "B", "C", "H"),
                  ("G", "F", "B", "C"),("A", "H", "D", "E"),("B", "C", "D", "F"),("G", "E", "H", "A"),
                  ("H", "E", "D", "B"),("C", "G", "F", "A"),("G", "H", "E", "C"),("B", "A", "D", "F"),
                  ("H", "B", "G", "A"),("C", "F", "E", "D"),("B", "G", "F", "H"),("A", "E", "C", "D"),
                  ("E", "C", "B", "D")]

# 發球得分 (Sideout) - 14 場 (擷取前 14 場)
SCHEDULE_8_SIDEOUT = [
    ("H", "A", "B", "D"), ("C", "G", "E", "F"), ("E", "B", "G", "A"), ("H", "C", "D", "F"), 
    ("B", "F", "D", "E"), ("H", "G", "A", "C"), ("H", "D", "E", "G"), ("F", "C", "A", "B"), 
    ("H", "B", "C", "E"), ("D", "A", "F", "G"), ("A", "E", "C", "D"), ("H", "F", "G", "B"), 
    ("G", "D", "B", "C"), ("H", "E", "F", "A")
]
...
SCHEDULE_7_DBL = [
    ...
    ("G", "C", "A", "E"),("F", "B", "G", "D"),("A", "C", "E", "B"),("D", "C", "G", "F"),
    ("B", "A", "E", "G"),("F", "C", "D", "A"),("E", "F", "G", "B"),("D", "E", "B", "C"),
    ("A", "G", "F", "D")
]
# 發球得分 (Sideout) - 14 場
SCHEDULE_7_SIDEOUT = [
    ("E", "G", "A", "C"), ("B", "F", "D", "C"), ("D", "E", "F", "G"), ("A", "G", "B", "C"), 
    ("A", "E", "D", "B"), ("F", "D", "C", "E"), ("G", "B", "A", "F"), ("C", "G", "B", "D"), 
    ("E", "A", "F", "C"), ("B", "E", "G", "D"), ("F", "C", "A", "D"), ("B", "G", "F", "E"), 
    ("A", "B", "E", "D"), ("C", "A", "G", "F")
]
