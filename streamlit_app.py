...
# 賽程邏輯定義 (請確保名稱與下方調用一致)
# ==========================================
SCHEDULE_8_DBL = [("H", "A", "B", "D"), ("C", "G", "E", "F"), ("E", "B", "G", "A"), ("H", "C", "D", "F"), ("B", "F", "D", "E"), ("H", "G", "A", "C"), ("H", "D", "E", "G"), ("F", "C", "A", "B"), ("H", "B", "C", "E"), ("D", "A", "F", "G"), ("A", "E", "C", "D"), ("H", "F", "G", "B"), ("C", "D", "B", "C"), ("H", "E", "F", "A"), ("A", "C", "B", "D"), ("E", "G", "F", "H"), ("A", "F", "B", "E"), ("C", "H", "D", "E"), ("A", "H", "B", "G"), ("C", "F", "D", "E")]
